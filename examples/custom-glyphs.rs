use glyphon::{
    Attrs, Buffer, Cache, Color, ContentType, CustomGlyph, Family, FontSystem, Metrics, RasterizeCustomGlyphRequest, RasterizedCustomGlyph, Resolution, Shaping, SwashCache, TextArea, TextAreaColorType, TextAtlas, TextBounds, TextRenderer, Viewport
};
use std::sync::Arc;
use wgpu::{
